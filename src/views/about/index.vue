    ...
    <div class="content" id="content">
      <header class="content-hd">
        <section class="title">
          ...
          <div class="job">
            <h2>
              {{ personalInfo.job
              }}<small> / {{ personalInfo.location }}</small>
            </h2>
          </div>
        </section>
        <section class="info">
          <h2>
            {{ personalInfo.info.gender }} / {{ personalInfo.info.birth }}
          </h2>
          <h3>
      ...
      <div class="content-bd">
        ...
        <section id="skill">
          ...
          <div class="section-bd">
            <div class="section-list">
              <div
                v-for="item in personalInfo.personalAbility"
                :key="item"
                class="mb-4"
              >
        ...
        <section id="practice">
          ...
          <div class="section-bd">
            <div
              v-for="item in personalInfo.workExperience"
              :key="item.company"
            >
              <div class="item-main">
        ...
        <section id="skillStack">
          ...
          <div class="mt-24">
            <p
              v-for="item in personalInfo.selfEvaluation"
              :key="item"
              class="section-content"
            >
              <i class="icon icon-dot"></i>
